...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('transaksi.tambah_pelanggan')); ?>" class="btn btn-primary">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form action="<?php echo e(route('transaksi.create')); ?>" method="GET">
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0">
                        <i class="fas fa-search text-muted"></i>
                    </span>
                    <input type="text" name="keyword" class="form-control border-start-0" 
                           placeholder="Cari nama pelanggan..." value="<?php echo e(request('keyword')); ?>">
            ...
            <?php if(request('keyword')): ?>
                <div class="alert alert-light mt-3 mb-0">
                    <i class="fas fa-info-circle me-2"></i> Menampilkan hasil pencarian untuk: "<?php echo e(request('keyword')); ?>"
                </div>
            <?php endif; ?>
        </div>
    </div>

    <form action="<?php echo e(route('transaksi.lanjutkan')); ?>" method="POST" id="formLanjutTransaksi">
        <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-primary select-btn" 
                                            data-pelanggan-id="<?php echo e($pelanggan->id); ?>">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">ID: <?php echo e($pelanggan->id); ?></small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <?php echo e($pelanggan->nomor_telepon); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kasir_19032\resources\views/transaksi/create.blade.php ENDPATH**/ ?>