...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3" data-aos="fade-down">
        <div>
            ...
            <p class="text-muted mb-0">Total: <?php echo e(count($pelanggans)); ?> pelanggan terdaftar</p>
        </div>
        <div>
            <a href="<?php echo e(route('transaksi.tambah_pelanggan')); ?>" class="btn btn-primary rounded-pill shadow-sm">
    ...
    <!-- Search form -->
    <form action="<?php echo e(route('pelanggan.index')); ?>" method="GET" class="mb-4" data-aos="fade-down">
        <div class="input-group w-100 w-md-50">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control rounded-start-pill" placeholder="Cari nama pelanggan...">
                    ...
                    <tbody>
                        ...
                        <tr class="border-top" data-aos="fade-right" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="mb-0"><?php echo e($pelanggan->nama); ?></h6>
                                        <small class="text-muted">ID: PLG<?php echo e(str_pad($pelanggan->id, 4, '0', STR_PAD_LEFT)); ?></small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span><?php echo e($pelanggan->nomor_telepon); ?></span>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5" data-aos="zoom-in">
                                ...
                                <a href="<?php echo e(route('transaksi.tambah_pelanggan')); ?>" class="btn btn-primary mt-3 rounded-pill">
                                    <i class="fas fa-plus-circle me-2"></i> Tambah Pelanggan
                                </a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kasir_19032\resources\views/pelanggan/index.blade.php ENDPATH**/ ?>