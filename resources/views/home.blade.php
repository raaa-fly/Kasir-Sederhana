            ...
            <div class="col-md-4 animate__animated animate__fadeInLeft">
                <div class="card card-hover border-0 shadow-sm h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <a href="{{ url('produk') }}" class="btn btn-primary px-4 btn-hover-scale">
            ...
            <div class="col-md-4 animate__animated animate__fadeInUp">
                <div class="card card-hover border-0 shadow-sm h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <a href="{{ url('transaksi') }}" class="btn btn-success px-4 btn-hover-scale">
                            <i class="fas fa-arrow-right me-2"></i> Masuk
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-4 animate__animated animate__fadeInRight">
                <div class="card card-hover border-0 shadow-sm h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <a href="{{ url('laporan') }}" class="btn btn-info px-4 text-white btn-hover-scale">
                            <i class="fas fa-arrow-right me-2"></i> Masuk
                        </a>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item border-0 py-3 animate__animated animate__fadeInUp" style="animation-delay: {{ $index * 0.1 }}s">
                                <div class="d-flex">
                                    <div class="me-3">
